...
| Low | Exceeded High | http://localhost:8001 | Percentage of responses with status code 5xx | 58 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 2xx | 16 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 3xx | 9 % |
| Info | Exceeded Low | http://localhost:8001 | Percentage of responses with status code 4xx | 15 % |
